...
pushers = [
    ...
    SimOpts('Gcav5_NoCurv', ["1000", "500", "100", "50", "10", "1", "0_1", "0_01", "0_001", "0_0001"], 'gca', branch="deucalion_gca", n_cells=80),
...
{{
  ...
  add_tag = .true.,
  push_type = {pusher},
  active_gca_components = "EXB", "gradB", "vEgradb", "E_par_F", "vEbgradb_F", "vEvEgradb_F", "mirror_F",
}}
